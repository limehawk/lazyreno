...
pub fn render(_app: &App, frame: &mut Frame, area: Rect, theme: &Theme) {
    ...
    let lines = vec![
        ...
        Line::from(Span::styled("  A            Merge all", plain)),
        Line::from(Span::styled("  x            Close PR", plain)),
        Line::from(Span::styled("  r            Rebase PR", plain)),
        Line::from(Span::styled("  R            Rebase all", plain)),
        Line::from(Span::styled("  e            Recreate PR", plain)),
        Line::from(Span::styled("  t            Retry PR", plain)),
        ...
        Line::from(Span::styled("  a            All repos", plain)),
        Line::from(Span::styled("  f            Toggle forks", plain)),
